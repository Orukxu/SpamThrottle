...
SpamThrottleProp = {};
SpamThrottleProp.Version = "Vanilla_1.11c";
...
SpamThrottleGSO2 = { "PRICE", "GOLD", "SKYPE", "EPIC", "DOLLARS", "PROFESSIONAL", "RELIABLE", "PROMOTION", "DELIVER", "NAXX", "GAMES", "GREETINGS", "WEBSITE" };
